...
const Cart: React.FC = () => {
  return (
    <div>
      <div
        id="selectQuantity"
        className="a-section a-spacing-none a-padding-none"
      >
        <span
        ...
        >
          <span className="a-button-inner">
            ...
            <input
              ...
              data-hover="Seleccione &lt;b&gt;__dims__&lt;/b&gt; a la izquierda&lt;br&gt; para añadir a la cesta."
      ...
      <div className="a-button-stack">
        ...
        <span
          id="submit.buy-now"
          className="a-button a-button-icon a-button-oneclick onml-buy-now-button"
        >
          <span className="a-button-inner">
