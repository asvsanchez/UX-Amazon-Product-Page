    ...
    <div>
      <div id="bylineInfo_feature_div" className="feature" data-feature-name="bylineInfo">
        <div className="a-section a-spacing-none">
          de
            <a id="bylineInfo" className="a-link-normal" href="/Amazon/b/ref=bl_dp_s_web_20312177031?ie=UTF8&amp;node=20312177031&amp;field-lbr_brands_browse-bin=Amazon">Amazon</a>
        </div>
      </div>
      <div id="title_feature_div" className="feature" data-feature-name="title">
